...
function Suggestions() {
    ...
    useEffect(() => {
        const fetchTrails = async () => {
            const endpoint = `${import.meta.env.VITE_REACT_APP_BACKEND_BASE_URL}/suggestions?country=${encodeURIComponent(country)}&state=${encodeURIComponent(state)}&city=${encodeURIComponent(city)}&activity=${activity}`; // URL to send request to
